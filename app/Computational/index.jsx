...
function MobileAppDev() {
  const mobileMaterial = [
    ...
    {title : 'Model Types and Classification'},
    {title : 'Model Development'},
    {title : 'Model Validation and Verification'},
    {title : 'Model Simulation and Analysis'},
    {title : 'Model Implementation and Deployment'},
    {title : 'Model Maintenance and Management'},
    {title : 'Model Evaluation and Optimization'},
    {title : 'Model Documentation and Reporting'},
  ];

  return (
    <ScrollView>
      <View style={styles.container}>
        <Text style={styles.title}>Computational Modelling</Text>
